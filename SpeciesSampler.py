...
class SpeciesSampler():
    ...
    def __init__(self, experiment_folder, rep_seed):
...
if __name__ == "__main__":
    ...
    parser.add_argument("seed", default = 0, type=int, help="Simulations are reproductible for a given set of parameters and a specific seed")
    parser.add_argument("threads", type=int, default = 1, help="number of thread for paralle job")
