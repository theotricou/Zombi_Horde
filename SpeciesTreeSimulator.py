...
class SpeciesTreeGenerator():
    ...
    def __init__(self, parameters, rep_seed):
    ...
    def start(self):
        ...
        self.active_lineages.add("10000")
        self.distances["10000"] = 0.0
    ...
    def run_b(self):
        ...
        self.branchwise_rates["10000"] = (speciation, extinction)
    ...
    def run_s(self):
        ...
        self.category_position["10000"] = (int(cat_speciation/2), int(cat_extinction/2))

        speciation = speciation_rates[self.category_position["10000"][0]]
        extinction = extinction_rates[self.category_position["10000"][1]]

        self.branchwise_rates = dict()
        self.branchwise_rates["10000"] = (speciation, extinction, s_speciation, s_extinction)
    ...
    def _get_speciated(self, lineage, time):
        ...
        c1name = str(10000 + self.lineages_counter)
        self.active_lineages.add(c1name)

        self.lineages_counter += 1
        c2name = str(10000 + self.lineages_counter)
